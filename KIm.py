...
class SecurityModule:
    """Enhanced security module for IoT data"""
...
class IoTDevice:
    def __init__(self, config: IoTDeviceConfig):
        ...
        self.zkp = None  # Also initialize Schnorr ZKP
...
class IoTDeviceGUI:
    ...
    def init_variables(self):
        """Initialize all GUI variables in one place"""
    ...
    def setup_core_components(self):
     try:
        ...
        self.mqtt_client.connect(MQTT_BROKER, MQTT_PORT, 60, clean_start=True)
    ...
    def update_device_list(self):
        """Update device list with proper error handling"""
        ...
        try:
            ...
            for device_id, device in self.devices.items():
                ...
                last_seen = (
                    ...
                    if hasattr(device, 'last_seen') and device.last_seen else "Never"
                )
            ...
            # Update all combo boxes safely
            device_list = list(self.devices.keys())
            for combo_name in ['batch_device_combo', 'key_device_combo', 'monitor_device_combo']:
    ...
    def verify_zkp(self):
        """Verify ZKP with comprehensive error handling"""
        try:
            if not hasattr(self, 'key_device_combo'):
                raise AttributeError("Security components not properly initialized")
    ...
    def generate_device_keys(self):
        ...
        try:
            ...
            # Generate keys
            public_key, private_key = self.security_module.generate_device_keys(device_id)
